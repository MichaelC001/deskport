...
#if defined(__MINGW32__) && !defined(D3D11_DECODER_PROFILE_AV1_VLD_PROFILE0)
// Same standard DXVA AV1 GUIDs, for toolchains whose d3d11.h predates them
// (mingw-w64 13.x still lacks the D3D11_DECODER_PROFILE_AV1_* spellings).
