...
UiPage {
    ...
    UiCard {
        ...
        ColumnLayout {
            ...
            Label { text: qsTr("Enable on both paired devices, then reconnect. New copies only; up to 128 MiB. Images and files are not shared."); color: ui.muted; wrapMode: Text.WordWrap; Layout.fillWidth: true }
