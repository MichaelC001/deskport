...
cp host/common/smartstream.h host/common/inputactivity.h host/common/framecadence.h "$host_app/Contents/Resources/deskport-smart-source/common/"
...
cp scripts/build-macos-host.sh scripts/patch-host-smart-stream.py scripts/patch-host-sync-cadence.py scripts/patch-host-input-activity.py "$host_app/Contents/Resources/"
