...
**Development prerelease: [0.3.9 Linux display lifecycle](docs/RELEASE_0.3.9_LINUX.md)** — KDE virtual-primary mirroring and GNOME adaptive extended displays, delivered through Nix.
