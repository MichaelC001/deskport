...
**Development prerelease: [0.3.7 Linux primary-display mirroring](docs/RELEASE_0.3.7_LINUX.md)** — KDE virtual-primary mirroring and GNOME adaptive extended displays, delivered through Nix.
