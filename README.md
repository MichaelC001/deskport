...
**Development prerelease: [0.3.8 Linux startup-mode recovery](docs/RELEASE_0.3.8_LINUX.md)** — KDE virtual-primary mirroring and GNOME adaptive extended displays, delivered through Nix.
