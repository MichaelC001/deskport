...
struct zkde_screencast_stream_unstable_v1_listener {
	 ...
	 * over the node id which is prone to id reuse. Will be sent before
	 * the created event.
	 * @param object_serial_hi high bits of the pipewire object serial
	 * @param object_serial_low low bits of the pipewire object serial
	 * @since 6
	 */
	void (*serial)(void *data,
		       struct zkde_screencast_stream_unstable_v1 *zkde_screencast_stream_unstable_v1,
		       uint32_t object_serial_hi,
		       uint32_t object_serial_low);
};
 ...
 * @ingroup iface_zkde_screencast_stream_unstable_v1
 */
#define ZKDE_SCREENCAST_STREAM_UNSTABLE_V1_SERIAL_SINCE_VERSION 6
